                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            ...
                            <div class="mb-5 text-center">
                                <p>Giriş yapmak için lütfen gerekli alanları doldurunuz. </p>
                            </div>
                            <form method="POST">
                                <div class="mb-3">
                                    <h4 class="font-weight-medium fs-3 mb-1">Telefon Numarası
                            ...
                            <div class="d-flex align-items-center">
                                <p class="fs-4 mb-0 text-dark">Hesabın yokmu?</p>
                                <a class="text-primary fw-medium ms-2" href="Register">Kaydol!</a>
                            </div>
                        </div>
                    </div>
                </div>
